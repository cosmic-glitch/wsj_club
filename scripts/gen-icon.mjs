...
//
// The 180×180 apple-touch-icon is full-bleed (iOS applies its own squircle
// mask). It mirrors the browser-tab favicon (app/icon.svg): the "RC" monogram
// from the site header (R solid, C outlined, Anton display face) on the
// brutalist signal-yellow tile with a thick square black frame. The letters
// are the real Anton glyph outlines baked to paths (no font dependency). If you
// change the design here, mirror it in app/icon.svg too.
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180">
  ...
  <rect x="5" y="5" width="170" height="170" fill="none" stroke="#0a0a0a" stroke-width="10"/>
  <g transform="translate(22.74 149) scale(0.067045 -0.067045)">
    <!-- R — solid -->
